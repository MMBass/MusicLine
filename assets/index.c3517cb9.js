var le=Object.defineProperty,ce=Object.defineProperties;var de=Object.getOwnPropertyDescriptors;var _=Object.getOwnPropertySymbols;var K=Object.prototype.hasOwnProperty,Y=Object.prototype.propertyIsEnumerable;var W=(t,r,o)=>r in t?le(t,r,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[r]=o,D=(t,r)=>{for(var o in r||(r={}))K.call(r,o)&&W(t,o,r[o]);if(_)for(var o of _(r))Y.call(r,o)&&W(t,o,r[o]);return t},b=(t,r)=>ce(t,de(r));var k=(t,r)=>{var o={};for(var n in t)K.call(t,n)&&r.indexOf(n)<0&&(o[n]=t[n]);if(t!=null&&_)for(var n of _(t))r.indexOf(n)<0&&Y.call(t,n)&&(o[n]=t[n]);return o};import{R as I,r as u,j as e,c as ee,M as pe,a as f,B as me,b as R,d as he,A as De,s as S,L as te,N as G,e as re,f as ne,g as fe,h as ge,i as O,I as xe,k as Ee,l as ye,C as Ce,T as Se,m as A,n as be,o as J,p as oe,G as N,q as ve,t as we,u as Le,D as Ne,v as Te,w as ke,x as Ae,y as ze,z as Be,E as Fe,F as Ie,H as $,J as se,K as Me,O as Pe,P as Re,Q as Oe,S as Z,U as $e,V as _e,W as je,X as He,Y as Je,Z as Ge}from"./vendor.47ea073b.js";const qe=function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const m of l.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&n(m)}).observe(document,{childList:!0,subtree:!0});function o(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerpolicy&&(l.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?l.credentials="include":s.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(s){if(s.ep)return;s.ep=!0;const l=o(s);fetch(s.href,l)}};qe();const j=I.createContext(void 0);function Ue(t){const[r,o]=u.exports.useState({}),l={openDrawer:(m,a,d="temporary",i)=>{o({open:m,anchor:a,permanent:d,child:i})},closeDrawer:(m,a,d="temporary",i)=>{o({open:m,anchor:a,permanent:d,child:i})}};return e(j.Provider,{value:D(D({},r),l),children:t.children})}const H=I.createContext(void 0);function Ve(t){const[r,o]=u.exports.useState({main:{open:!1,color:"primary"},circular:{open:!1,color:"primary"}}),m={createLoader:(a,d)=>{r[a]&&o(b(D({},r),{[a]:void 0})),o(b(D({},r),{[a]:{open:!1,color:d||"primary"}}))},openLoader:a=>{r[a]?o(b(D({},r),{[a]:b(D({},r[a]),{open:!0})})):console.error("Loader does'nt exist. Name: "+a)},closeLoader:a=>{r[a]?o(b(D({},r),{[a]:b(D({},r[a]),{open:!1})})):console.error("Loader does'nt exist. Name: "+a)}};return e(H.Provider,{value:D(D({},r),m),children:t.children})}const M=I.createContext(void 0);function We(t){const[r,o]=u.exports.useState({main:{open:!0,severity:"warning",title:"\u05D4\u05D0\u05EA\u05E8 \u05D1\u05D1\u05E0\u05D9\u05D4",message:""},snackbar:{open:!1,severity:"success",title:"",message:"This is a Snackbar!"}}),m={createBanner:(a,d,i,p)=>{r[a]&&o(b(D({},r),{[a]:void 0})),o(b(D({},r),{[a]:{open:!0,severity:d||"success",title:i||"",message:p||""}}))},openBanner:a=>{r[a]?o(b(D({},r),{[a]:b(D({},r[a]),{open:!0})})):console.error("Banner does'nt exist. Name: "+a)},closeBanner:a=>{o({main:{open:!0,severity:"warning",title:"\u05D4\u05D0\u05EA\u05E8 \u05D1\u05D1\u05E0\u05D9\u05D4",message:""},snackbar:{open:!1,severity:"success",title:"",message:"This is a Snackbar!"}}),r[a]?o(b(D({},r),{[a]:b(D({},r[a]),{open:!1})})):console.error("Banner does'nt exist. Name: "+a)}};return e(M.Provider,{value:D(D({},r),m),children:t.children})}const ie=ee({direction:"rtl",typography:{fontFamily:["Assistant","Roboto","sans-serif"].join(",")},palette:{primary:{main:"#CD5A91",light:"#ff8bc1",dark:"#AC4C7A"},secondary:{main:"#edf2ff",dark:"#737373",light:"#EBECF0"}}});function Ke(){const[t,r]=u.exports.useState(ie.palette.primary.main);return e("div",{className:"wrapper",children:e(pe,{children:e("meta",{name:"theme-color",content:t})})})}const q=I.createContext(void 0);function Ye(t){const[r,o]=u.exports.useState({fontSize:{sm:Number(localStorage.getItem("font_sm"))||15,md:Number(localStorage.getItem("font_md"))||25},colors:"pink"}),n=()=>{r.fontSize.md<60&&(o(b(D({},r),{fontSize:{sm:r.fontSize.sm+1,md:r.fontSize.md+1}})),l())},s=()=>{r.fontSize.sm>2&&(o(b(D({},r),{fontSize:{sm:r.fontSize.sm-1,md:r.fontSize.md-1}})),l())};function l(){localStorage.setItem("font_md",r.fontSize.md),localStorage.setItem("font_sm",r.fontSize.sm)}function m(){localStorage.setItem("colors_mode",r.colors)}function a(i){o(b(D({},r),{colors:i})),m()}const d={reduceFontSize:s,increaseFontSize:n,setColors:a};return e(q.Provider,{value:D(D({},r),d),children:t.children})}function Ze({className:t}){const r=u.exports.useContext(q);return e("div",{id:"",className:t,children:f(me,{className:"button-group",children:[e(R,{"aria-label":"reduce",onClick:()=>{r.reduceFontSize()},children:e(he,{fontSize:"small"})}),e(R,{className:"font-size-disabled",disabled:!0,children:"\u05D2\u05D5\u05D3\u05DC \u05D4\u05D8\u05E7\u05E1\u05D8"}),e(R,{"aria-label":"increase",onClick:()=>{r.increaseFontSize()},children:e(De,{fontSize:"small"})})]})})}const Qe=S(Ze)`
  text-align: end;
...
`;const ot=o=>{var n=o,{className:t}=n,r=k(n,["className"]);var i,p,x,E;u.exports.useContext(j);const s=u.exports.useContext(z),l=u.exports.useContext(M),[m,a]=u.exports.useState(!1),d=function(){sessionStorage.removeItem("currLines")};return u.exports.useEffect(()=>{var L;a(((L=l.error)==null?void 0:L.open)&&!0)},[(i=l.error)==null?void 0:i.open]),f(ye,{position:"sticky",className:t,children:[e(Ce,{maxWidth:"xl",children:f(Se,{disableGutters:!0,children:[e(G,{to:"/",onClick:()=>{d()},children:e(A,{variant:"h6",noWrap:!0,component:"h1",sx:{mr:2,display:"flex"},children:"\u05DE\u05D9\u05D5\u05D6\u05D9\u05E7 \u05DC\u05D9\u05D9\u05DF"})}),s.lines[0]&&e(Qe,{})]})}),e(be,{in:(p=l.error)==null?void 0:p.open,children:f(J,{severity:"error",className:"error-alert",onClose:()=>{l.closeBanner("error")},children:[e(oe,{children:(x=l.error)==null?void 0:x.title}),(E=l.error)==null?void 0:E.message]})})]})},st=S(ot)`
...
`;function mt(o){var n=o,{className:t}=n,r=k(n,["className"]);const[s,l]=u.exports.useState(!0);return e(ze,{className:t,open:s,onClose:()=>{l(!1)},"aria-labelledby":"modal-modal-title","aria-describedby":"modal-modal-description",children:r.children})}S(mt)`
  #main-modal-root{
    z-index: 1500;
...
`;function vt({className:t}){const r=u.exports.useContext(j),o=u.exports.useContext(H),n=u.exports.useContext(M);u.exports.useRef(null);const s=Me({key:"muirtl",stylisPlugins:[je,He]});function l(){m()}const m=()=>{const d=document.createElement("script");d.type="text/javascript",d.src="https://cse.google.com/cse.js?cx=a85c2374ffc8b8898",d.defer=!0,document.body.appendChild(d)};u.exports.useEffect(()=>{l()},[n]);const a=d=>{n.closeBanner(d)};return ee({palette:{mode:"dark"}}),f("div",{className:t,children:[e(Pe,{value:s,children:f(Re,{children:[e(Ke,{}),e(st,{className:"header"}),n.main.open&&f(J,{severity:"warning",className:"main-alert",children:[e(oe,{children:n.main.title}),n.main.message]}),e(at,{children:f(Oe,{children:[e(Z,{path:"/",element:e(Ct,{className:"page"})}),e(Z,{path:"*",element:e(bt,{className:"page"})})]})}),r.open&&r.child&&e(dt,{className:"drawer"}),o.main.open&&e(se,{color:o.main.color||"primary"}),o.circular.open&&e($e,{color:o.main.color||"primary"}),n.snackbar.open&&e(_e,{open:n.snackbar.open,autoHideDuration:6e3,onClose:()=>{},children:e(J,{onClose:()=>{a("snackbar")},severity:n.snackbar.severity,sx:{width:"100%"},children:n.snackbar.message})}),e(lt,{})]})}),e(Dt,{})]})}const wt=S(vt)`
  height: 100vh;
  height: fit-content;
  min-height: 700px;
  color: ${t=>t.theme.palette.secondary.main};
...
`,Lt=[Ye,Ue,We,Ve,tt];function Nt(t){return e($,{children:Lt.reduceRight((r,o)=>e(o,{children:r}),t.children)})}Je.render(e(I.StrictMode,{children:e(Nt,{children:e(Ge,{theme:ie,children:e(wt,{className:"app"})})})}),document.getElementById("root"));
