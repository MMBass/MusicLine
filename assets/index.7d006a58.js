...
`;function Xe({className:e}){const r=l.exports.useContext(C);return t(E,{children:t(S,{container:!0,spacing:2,children:r.lines&&t("div",{id:"lyrics_body",className:e,children:r.lines.map((n,o)=>p(A,{children:[t(S,{className:"lyrics-line en-line",item:!0,children:n.split(" ").map((a,i)=>t(Qe,{lyric:a},i))},o.toString()+Math.floor(Math.random()*3e4)),t(S,{item:!0,className:"lyrics-line he-line",children:t("small",{className:"single-trans",children:"\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD.."},o)},o.toString()+Math.floor(Math.random()*3e4))]}))})})})}const Ye=d(Xe)`
   max-width: 90%;
