...
`,Ye=o=>{var s=o,{className:e}=s,r=v(s,["className"]);const i=c.exports.useContext(I),l=c.exports.useContext(w),a=()=>{i.openDrawer(!0,"left","temporary",We)};return t(me,{position:"sticky",className:e,children:t(fe,{maxWidth:"xl",children:g(ge,{disableGutters:!0,children:[t(H,{to:"/",children:t(L,{id:"hsix",variant:"h6",noWrap:!0,component:"div",sx:{mr:2,display:"flex"},children:"\u05DE\u05D9\u05D5\u05D6\u05D9\u05E7 \u05DC\u05D9\u05D9\u05DF"})}),l.lines[0]&&t(qe,{}),t(B,{sx:{display:{xs:"flex",md:"flex"},flexGrow:1},children:t(Xe,{onClick:a})})]})})})},Ze=D(Ye)`
