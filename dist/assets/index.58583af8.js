...
`;function ze(n){var o=n,{className:e}=o,r=f(o,["className"]);const a=u.exports.useContext(S);return t(ee,{className:e,anchor:a.anchor,open:a.open,variant:a.permanent,onClose:()=>{a.toggleDrawer(!1)},children:t(w,{className:"drawer-layout",sx:{width:a.anchor==="top"||a.anchor==="bottom"?"auto":250},role:"presentation",onClick:()=>{a.toggleDrawer(!1)},children:t(a.child,{})})})}const Ie=d(ze)`
  color: #F4F5F7;
...
`;function tt({className:e}){const r=u.exports.useContext(S),n=u.exports.useContext(O),o=u.exports.useContext($),a=u.exports.useRef(null),[s,i]=u.exports.useState(!1),h=ce({key:"muirtl",stylisPlugins:[De,fe]});function D(){k()}const k=()=>{const m=document.createElement("script");m.type="text/javascript",m.src="https://cse.google.com/cse.js?cx=a85c2374ffc8b8898",m.defer=!0,document.body.appendChild(m)};u.exports.useEffect(()=>{D(),i(!0),window.onscroll=()=>{_()}},[]);const _=()=>{a.current&&window.pageYOffset>a.current.offsetTop},z=m=>{o.toggleBanner(m)};return l("div",{className:e,ref:a,children:[t(le,{value:h,children:l(ue,{children:[t(Se,{}),t(Te,{className:"header"}),o.main.open&&l(F,{severity:"warning",className:"main-alert",children:[t(de,{children:o.main.title}),o.main.message]}),t(Fe,{children:l(pe,{children:[t(N,{path:"/",element:t(Qe,{className:"page"})}),t(N,{path:"/about",element:t(Xe,{className:"page"})}),t(N,{path:"*",element:t(et,{className:"page"})})]})}),r.open&&r.child&&t(Ie,{className:"drawer"}),n.main.open&&t(he,{color:n.main.color||"primary"}),n.circular.open&&t(me,{color:n.main.color||"primary"}),o.snackbar.open&&t(ge,{open:o.snackbar.open,autoHideDuration:6e3,onClose:()=>{},children:t(F,{onClose:()=>{z("snackbar")},severity:o.snackbar.severity,sx:{width:"100%"},children:o.snackbar.message})}),t(_e,{})]})}),t(Ue,{})]})}const rt=d(tt)`
  height: 100vh;
  min-height: 700px;
  color: ${e=>e.theme.palette.secondary.main};
