...
`,E=k.createContext(void 0);function We(e){const n=u.exports.useContext(H),[o,s]=u.exports.useState(sessionStorage.getItem("currLines")||!1),[r,l]=u.exports.useState([]),[i,a]=u.exports.useState(JSON.parse(sessionStorage.getItem("currLines"))||[]),[h,m]=u.exports.useState(0),g="https://musicline-backend-basssites.vercel.app",L=b=>{n.openLoader("main"),fetch(`${g}/lyrics`,{method:"post",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({currSong:b})}).then(d=>d.json()).then(d=>{var c,y,w;if(n.closeLoader("main"),(w=(y=(c=d==null?void 0:d.message)==null?void 0:c.body)==null?void 0:y.lyrics)==null?void 0:w.lyrics_body){let v=d.message.body.lyrics.lyrics_body;v=v.substring(0,v.indexOf("..."));let N=[];v.split(/(?:\r\n|\r|\n)/g).map(q=>{q.length>=2&&N.push({src:q,trans:""})}),a(N),s(v),l(v.split(" "));let z=document.querySelector(".gsst_a");z&&z.dispatchEvent(new Event("click"))}})},P=()=>{let b=!1;for(let d=0;d<i.length;d++){let c=i[d];if(b===!0)break;if(c.trans.length<=1||c.trans==="\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD.."){b=!0,T(c.src,d);break}else continue}},T=(b,d)=>{fetch(`${g}/line-trans`,{method:"post",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({lines:i})}).then(c=>c.json()).then(c=>{var w,v;let y=i;(c==null?void 0:c.trans.length)?(c.trans.map((N,z)=>{y[z]={src:y[z].src,trans:N}}),a(y),m(h+1)):(c==null?void 0:c.trans)?(y[d]={src:b,trans:c==null?void 0:c.trans},a(y),((w=i[i.length-1])==null?void 0:w.trans).length>=1&&sessionStorage.setItem("currLines",JSON.stringify(i)),m(h+1)):(i[d].trans===void 0&&(y[d]={src:b,trans:"\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD.."}),i[d].trans==="\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD.."&&(y[d]={src:b,trans:"[missing]"}),a(y),((v=i[i.length-1])==null?void 0:v.trans).length>=1&&sessionStorage.setItem("currLines",JSON.stringify(i)),m(h+1))}).catch(c=>{var v;let y=i;i[d].trans===""&&(y[d]={src:b,trans:"\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD.."}),i[d].trans==="\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD.."&&(y[d]={src:b,trans:"[missing]"}),a(y),((v=i[i.length-1])==null?void 0:v.trans).length>=1&&sessionStorage.setItem("currLines",JSON.stringify(i)),m(h+1),console.log(c)})},I={getLines:L,getLinesTrans:T,checkNextTrans:P};return t(E.Provider,{value:p({currLyrics:o,singles:r,lines:i,cou:h},I),children:e.children})}function Ve({className:e}){return u.exports.useContext(E),t(M,{className:e,sx:{flexGrow:1,display:{xs:"none",md:"flex"}},children:[].map(o=>t($,{to:o.url,children:t(A,{sx:{my:2},children:o.name})},o.name))})}const Ke=f(Ve)`
  
`,Qe=o=>{var s=o,{className:e}=s,n=C(s,["className"]);const r=u.exports.useContext(O),l=u.exports.useContext(E);return t(ue,{position:"static",className:e,children:t(de,{maxWidth:"xl",children:x(pe,{disableGutters:!0,children:[t(M,{sx:{display:{xs:"flex",md:"none"}},children:t(he,{size:"large","aria-label":"account of current user","aria-controls":"menu-appbar","aria-haspopup":"true",onClick:()=>{r.openDrawer(!0,"left","temporary",Ue)},color:"inherit",children:t(me,{})})}),t($,{to:"/",children:t(S,{variant:"h6",noWrap:!0,component:"div",sx:{mr:2,display:"flex"},children:"\u05DE\u05D9\u05D5\u05D6\u05D9\u05E7 \u05DC\u05D9\u05D9\u05DF"})}),l.lines[0]&&t(qe,{}),t(Ke,{className:"nav-bar"})]})})})},Xe=f(Qe)`
...
`;function nt(o){var s=o,{className:e}=s,n=C(s,["className"]);const r=u.exports.useContext(O);return t(fe,{className:e,anchor:r.anchor,open:r.open,variant:r.permanent,onClose:()=>{r.closeDrawer(!1)},children:t(M,{className:"drawer-layout",sx:{width:r.anchor==="top"||r.anchor==="bottom"?"auto":250},role:"presentation",onClick:()=>{r.closeDrawer(!1)},children:t(r.child,{})})})}const rt=f(nt)`
  color: #F4F5F7;
...
`;function ot({className:e}){const[n,o]=u.exports.useState(!0),s=()=>{o(!1)};return x(ge,{id:"main-modal-root",className:e,open:n,onClose:s,"aria-labelledby":"alert-dialog-title","aria-describedby":"alert-dialog-description",sx:{zIndex:1500},children:[t(xe,{id:"alert-dialog-title",children:"\u05D1\u05E8\u05D5\u05DA \u05D4\u05D1\u05D0 \u05DC\u05DE\u05D9\u05D5\u05D6\u05D9\u05E7 \u05DC\u05D9\u05D9\u05DF"}),t(ye,{children:t(De,{id:"alert-dialog-description",children:"Built with love using Vite build tool, React and Mui UI library."})}),t(be,{children:t(A,{onClick:s,children:"Close"})})]})}f(ot)`
...
`;function ut(o){var s=o,{className:e}=s,n=C(s,["className"]);const r=u.exports.useContext(E),[l,i]=u.exports.useState(!1),[a,h]=u.exports.useState(5e4),[m,g]=u.exports.useState([]);u.exports.useEffect(()=>{var c;((c=r.lines[r.lines.length-1])==null?void 0:c.trans).length>=1&&h(0)},[r.lines]);const L=()=>{var c;((c=r.lines[r.lines.length-1])==null?void 0:c.trans).length>=1&&(i(!0),T())},P=()=>{i(!1)},T=u.exports.useCallback(()=>{I()},[]);function I(){fetch("https://musicline-backend-basssites.vercel.app/single-trans",{method:"post",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({single:encodeURI(n.lyric)})}).then(c=>c.json()).then(c=>{(c==null?void 0:c.results[0])?g(c.results):g(["\u05DC\u05D0 \u05E0\u05DE\u05E6\u05D0"])}).catch(c=>{console.log(c)})}const b=()=>m[1]?m.map((d,c)=>x(F,{children:[c>0&&t("hr",{}),t("p",{className:"tt-p",children:d})]})):t("p",{className:"tt-p",children:"\u05DC\u05D0 \u05E0\u05DE\u05E6\u05D0"});return t(Se,{onClickAway:P,children:t(Ee,{className:e,title:x(F,{children:[t(S,{color:"inherit",children:" \u05EA\u05E8\u05D2\u05D5\u05DE\u05D9\u05DD \u05E0\u05D5\u05E1\u05E4\u05D9\u05DD:"}),t("div",{className:"tt-body",style:{textAlign:"center",maxHeight:"110px",overflowY:"auto",direction:"ltr"},children:m[0]?t(b,{}):t(V,{sx:{margin:"8px"},color:"primary"})})]}),arrow:!0,enterDelay:a,enterTouchDelay:a,leaveTouchDelay:60*1e3,leaveDelay:0,onOpen:()=>{T()},PopperProps:{disablePortal:!1},onClose:P,open:l,disableFocusListener:!0,disableTouchListener:!0,disableHoverListener:!0,children:t("p",{className:"single-lyric",onClick:L,children:n.lyric})})})}const dt=f(ut)`

`;function pt(o){var s=o,{className:e}=s,n=C(s,["className"]);const r=u.exports.useContext(E);return u.exports.useEffect(()=>{r.checkNextTrans()},[r,r.cou]),t(M,{children:t(R,{container:!0,spacing:2,children:r.lines&&t("div",{id:"lyrics_body",className:e,children:r.lines.map((l,i)=>{var a;return x("div",{children:[t(R,{className:"lyrics-line en-line",item:!0,children:l.src.split(" ").map((h,m)=>t(dt,{lyric:h},m))},i.toString()+Math.floor(Math.random()*3e4)),t(R,{item:!0,className:"lyrics-line he-line",children:t(F,{children:((a=l.trans)==null?void 0:a.length)>2?l.trans.split(" ").map((h,m)=>t("small",{onLoad:()=>{r.checkNextTrans()},className:"single-trans",children:h},m)):t("small",{className:"single-trans",children:"\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD..."})})},i.toString()+Math.floor(Math.random()*3e4))]})})})})})}const ht=f(pt)`
   /* max-width: 90%; */
