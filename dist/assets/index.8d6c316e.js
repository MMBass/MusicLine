...
`;function Ge({className:e}){return t("div",{id:"",className:e})}const Ue=d(Ge)`
  ...
  width: 0px !important;
`;function Ve({className:e}){function r(n){let o=document.querySelector("#gsc-i-id1");if(o){o.value=n.target.value;let a=document.querySelectorAll(".gsc-search-box button")[0];a?setTimeout(()=>{a.dispatchEvent(new Event("click"))},100*Math.floor(Math.random()*4)):console.error("no gsc loaded")}else console.error("no gsc loaded")}return l("div",{id:"",className:e,children:[t(ie,{id:"outlined-search",label:"\u05D7\u05E4\u05E9 \u05E9\u05D9\u05E8",type:"search",className:"main-input",onChange:r,autoFocus:!0}),t("div",{className:"gcse-search"})]})}const We=d(Ve)`
