...
`,Xe=[ye,ve,Ee];function Ze(e){return t(ge,{children:Xe.reduceRight((r,n)=>t(n,{children:r}),e.children)})}De.render(t(b.StrictMode,{children:t(Ze,{children:t(fe,{theme:O,children:t(Ye,{className:"app"})})})}),document.getElementById("root"));
