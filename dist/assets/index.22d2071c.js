...
`;function Ge(n){var a=n,{className:e}=a,r=v(a,["className"]);const[o,i]=l.exports.useState(!0);return t(le,{className:e,open:o,onClose:()=>{i(!1)},"aria-labelledby":"modal-modal-title","aria-describedby":"modal-modal-description",children:r.children})}d(Ge)`
  #main-modal-root{
    z-index: 1500;
...
`;function Xe({className:e}){const r=l.exports.useContext(C);return t(E,{children:t(S,{container:!0,spacing:2,children:r.lines&&t("div",{id:"lyrics_body",className:e,children:r.lines.map((n,a)=>p(A,{children:[t(S,{className:"lyrics-line en-line",item:!0,children:n.split(" ").map((o,i)=>t(Qe,{lyric:o},i))},a.toString()+Math.floor(Math.random()*3e4)),t(S,{item:!0,className:"lyrics-line he-line",children:n.split(" ").map((o,i)=>t("small",{className:"single-trans",children:o&&"\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD.."},i))},a.toString()+Math.floor(Math.random()*3e4))]}))})})})}const Ye=d(Xe)`
   max-width: 90%;
